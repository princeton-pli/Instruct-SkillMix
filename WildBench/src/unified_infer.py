...
def parse_args():
    ...
    parser.add_argument('--stop_token_ids',default="", type=str)
...
if __name__ == "__main__":
    ...
    if not args.stop_token_ids is None and args.stop_token_ids != "":
        stop_token_ids = [int(id) for id in args.stop_token_ids.split(",")]
