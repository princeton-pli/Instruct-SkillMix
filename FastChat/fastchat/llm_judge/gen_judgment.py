...
if __name__ == "__main__":
    ...
    parser.add_argument("--answer-dir", type=str, help="The directory containing answer files.")
    parser.add_argument("--output-dir", type=str, help="The directory to output annotation files.")
    parser.add_argument(
        "--judge-file",
        type=str,
    ...
    if args.output_dir:
        ...
        output_dir = f"data/{args.bench_name}/model_judgment"
    ...
    if args.mode == "single":
        ...
        judge_model = args.judge_model.replace("azure-", "")
        output_file = (
            f"{output_dir}/{judge_model}_single.jsonl"
        )
        ...
        output_file = (
            f"{output_dir}/{args.judge_model}_pair.jsonl"
        )
